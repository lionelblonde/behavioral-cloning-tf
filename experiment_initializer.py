...
class ExperimentInitializer:
    ...
    def get_long_name(self):
        ...
        elif self.args.task in ['train_ppo_expert']:
    ...
    def get_log_path(self):
        ...
        if self.args.task in ['train_ppo_expert', 'clone']:
            log_name = self.get_long_name()
        elif self.args.task in ['evaluate_ppo_expert',
                                'evaluate_bc_policy',
                                'gather_ppo_expert']:
